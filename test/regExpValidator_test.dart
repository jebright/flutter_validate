...
void main() {
  group('Regex Validator Tests', () {
    ...
    test(
        'valid US phone # with dashes and parenthesis, isValid called, is True',
        () {
      expect(RegExpValidator.isValidUSPhoneNumber('(559) 673-2076'), true);
    });
    ...
    test(
        'valid Australia phone # with spaces, isValid called for US #, is false',
        () {
